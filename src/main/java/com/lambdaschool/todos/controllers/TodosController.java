...
public class TodosController
{
    ...
    public ResponseEntity<?> updateTodo(@RequestBody Todos updateTodos,
                                        @PathVariable Long todoid) {
        todosService.update(updateTodos, todoid);
        return new ResponseEntity<>(updateTodos, HttpStatus.OK);
    }
